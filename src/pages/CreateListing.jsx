...
export default function CreateListing() {
  ...
  async function onSubmit(e) {
    ...
    if (geolocationEnabled) {
      //For get geocode api key we need pay to google... still we don't have API key
      // when geolocationEnabled true then it works...
      ...
      if (location === undefined) {
        ...
        // when geolocationEnabled false then it works...
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="mb-6">
          ...
          <input
            ...
            multiple
            required
            className="w-full px-3 py-1.5 text-gray-700 bg-white border-gray-300 
